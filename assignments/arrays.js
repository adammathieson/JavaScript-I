...
// console.log(`Car 33 is a *car year goes here* *car make goes here* *car model goes here*` );
    ...
    // const recall = inventory.find(item => item.id === 33);

    // console.log(`Car ${recall.id} is a ${recall.car_year} ${recall.car_make} ${recall.car_model}`);

    // console.log(`Car ${recall[0].id} is a ${recall[0].car_year} ${recall[0].car_make} ${recall[0].car_model}`);

    // function recall(car) {
    //     return car.id === 33;
    // }

    // console.log(inventory.find(recall));
